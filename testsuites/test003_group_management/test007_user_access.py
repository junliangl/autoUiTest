...
class Test_User_Access(unittest.TestCase):
    ...
    def test03_users_management(self):
        """
        测试查看用户
        """
        user_access_page = User_Access_Page(self.driver)
    ...
    def test04_invite_to_group(self):
        """
        测试邀请入组
        """
        user_access_page = User_Access_Page(self.driver)
